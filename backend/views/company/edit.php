                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group <?php if(isset($error['name'])):?>has-error<?php endif;?>">
                            ...
                            <div class="col-sm-8">
                                <textarea name="Company[instroduce]" placeholder="简介" rows="5"  class="form-control"><?=$company->instroduce;?></textarea>
                            </div>
                        ...
                        <div class="form-group <?php if(isset($error['remarks'])):?>has-error<?php endif;?>">
                            ...
                            <div class="col-sm-8">
                                <textarea name="Company[remarks]" placeholder="备注" rows="5"  class="form-control"><?=$company->remarks;?></textarea>
                            </div>
