...
<div class="row" >
    ...
    <div class="col-xs-3" id="myScrollspy">
        <ul class="nav nav-tabs nav-stacked affix" id="myNav" >
            ...
            <li><a href="#section-2">我的优势</a></li>
            <li><a href="#section-3">求职意向</a></li>
            <li><a href="#section-4">工作经历</a></li>
            <li><a href="#section-5">项目经验</a></li>
            <li><a href="#section-6">教育经历</a></li>
            <li><a href="#section-7">社交账号</a></li>
        </ul>
    </div>
...
<?php $this->registerJs($this->blocks['test'], \yii\web\View::POS_READY);?>
